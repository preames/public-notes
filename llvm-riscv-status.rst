...
[http://maskray.me/blog/2021-03-14-the-dark-side-of-riscv-linker-relaxation][maskray has a writeup] on the topic.

gkm has a patch up ([https://reviews.llvm.org/D125036]).  This was split off an earlier patch which included both support for the functional fix and the broader topic of linker optimization and relaxation.  
...
See discussion [https://github.com/google/oss-fuzz/pull/7179#issuecomment-1092802635][here] and linked pull requests on the OSS Fuzz repo.
